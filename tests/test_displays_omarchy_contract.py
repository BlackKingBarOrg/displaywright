...
displaywright only writes the toggle file; Omarchy is what puts the panel back when
...
class OmarchyContractTests(unittest.TestCase):
    ...
    def test_panel_comes_back_when_no_external_is_active(self):
        ...
        # Position and scale come from the rule displaywright leaves in monitors.lua,
