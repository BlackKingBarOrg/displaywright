"""Named layout profiles, stored as JSON under ``~/.config/displaywright``.
...
from ..model import Mode, MonitorState, bounding_box
...
def summary_line(states: Sequence[MonitorState]) -> str:
    """Short text describing a layout, for the command line."""
